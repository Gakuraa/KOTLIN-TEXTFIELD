...
fun Greeting() {
    ...
    Column(
        ...
        Row (verticalAlignment = Alignment.CenterVertically){
            Checkbox(checked = java, onCheckedChange = {isSelected->
                java = isSelected
        ...
        Row (verticalAlignment = Alignment.CenterVertically){
            Checkbox(checked = cSharp, onCheckedChange = {isSelected->
                cSharp = isSelected})
            Text(text = "C-Sharp")
        }
        ...
        Row (verticalAlignment = Alignment.CenterVertically){
            RadioButton(
                selected = linguagemSelecionada == 3,
                onClick = { linguagemSelecionada = 3},
                colors = RadioButtonDefaults.colors(
                    selectedColor = Color.Green,
                    unselectedColor = Color.Magenta
                )
        ...
        Row (horizontalArrangement = Arrangement.SpaceAround,
            ...
            Button(
                onClick = { cor = Color.Red },
                modifier = Modifier.size(width = 150.dp, height = 150.dp),
                colors = ButtonDefaults.buttonColors(
                    containerColor = Color(0xFF43C9AD),
                    contentColor = Color(0xFF1B2D3F)
                ),
                border = BorderStroke(2.dp, Color(0xFF123456)),
                shape = CircleShape
            ) {
               Row (
